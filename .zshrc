...
plugins=(git git-flow git-extras colored-man cp extract history symfony2 grails osx ruby renewa safe-paste bower composer terminalapp battery meteor gulp yarn z)
