...
plugins=(git git-flow git-extras colored-man cp extract history symfony2 apache2-macports coffee macports grails osx ruby renewa safe-paste bower composer terminalapp battery meteor gulp)
